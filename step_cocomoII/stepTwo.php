<div class="tab">
  ...
  <table border="0" class="table">
    ...
    <tr>
      <td>UFP : <input readonly placeholder="Total" oninput="this.className = ''" id="UFPFromStepOne"></td>
      <td>SLOC : <input readonly placeholder="Total" oninput="this.className = ''" id="SLOC" name="SLOC"></td>
      <td>SIZE : <input readonly placeholder="Total" oninput="this.className = ''" id="SIZE" name="SIZE"></td>
    </tr>
