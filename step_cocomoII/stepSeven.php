  ...
  <div id="Waterfall" class="tabcontent11">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td> <input type="number" oninput="this.className = ''" id="SpecificationsPayrate" name="SpecificationsPayrate">
        </td>
        <td>
          <input type="number" oninput="this.className = ''" id="valueSpecificationsPayrate"
